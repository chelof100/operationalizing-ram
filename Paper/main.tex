...
\node[layer] (comp)   [below=of alloc]
      {Paper 4 --- Compositional Governance\\(Four dimensions are irreducible; structure cannot be collapsed)};
\node[layer] (iml)    [below=of comp]
